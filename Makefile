...
gen-crd-doc:
	...
	${DORP} run --userns=keep-id --user=$$(id -ur):$$(id -gr) -v ./content/en/docs/Configuration:/opt/crd-docs-generator/output:z -v ./tmp-crd-docs:/opt/crd-docs-generator/config:z quay.io/giantswarm/crd-docs-generator:0.9.0 --config /opt/crd-docs-generator/config/apigen-config.yaml
	rm -rf ./tmp-crd-docs
