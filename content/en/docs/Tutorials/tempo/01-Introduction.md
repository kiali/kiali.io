...
Kiali uses [Jaeger]({{< ref "/docs/Configuration/external-services/tracing-jaeger" >}}) as a default distributed tracing backend. In this tutorial, we will replace it for [Grafana Tempo](https://grafana.com/docs/tempo/next/).
