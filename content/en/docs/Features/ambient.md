...
{{% alert color="warning" %}}
For Kiali to detect Ambient, it needs to have access to the namespace were ztunnel is deployed. This is usually the istio namespace, but in platforms as OpenShift, might be a different one.
{{% /alert %}}
