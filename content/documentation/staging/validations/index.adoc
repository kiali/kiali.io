...
[source, yaml]
----
include::/data/files/validation_examples/704.yaml[]
----

==== See Also

https://github.com/kiali/kiali/blob/master/business/checkers/services/port_mapping_checker.go[Validator source code, window="_blank"] +
https://istio.io/latest/docs/ops/configuration/traffic-management/protocol-selection[Istio documentation port naming convention, window="_blank"]
