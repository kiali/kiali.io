...
The Request Timeouts Wizard sets up request timeous in Envoy, using Istio.
...
And a user may want to add Traffic Policies to secure that communication. In other words, to prevent traffic other than the currently reflected in the Graph's Services and Workloads.
