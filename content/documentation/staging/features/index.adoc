...
Kiali gives support to configure the health status.

=== Error Rate

Kiali use configuration to calculate the error requests to check the status of the resource (service, workload, app...). link:/documentation/staging/health-configuration/[Health Configuration documentation]
