...
Check section Google Kubernetes Engine (GKE) Private Cluster requirements in the https://kiali.io/documentation/latest/installation-guide/#_google_cloud_private_cluster_requirements[Installation Guide, window="_blank"].
