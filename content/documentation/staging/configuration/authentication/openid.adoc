...
icon:bullhorn[size=1x]{nbsp} This secret is not needed if you don't want to
Kiali to use the _authorization code flow_ (i.e. if your signing key is not either 16,
24 or 32 bytes long).
