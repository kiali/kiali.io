...
* link:{{< relref "header" >}}[header]: requires kiali to run behind a reverse proxy that is responsible for injecting the user's token or a toekn with impersonation.
