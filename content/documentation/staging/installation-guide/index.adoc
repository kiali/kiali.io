...
If installing Kiali into an OpenShift Kubernetes distribution then follow the minimal preparation below. For other Kubernetes distributions you can skip to the next section.
