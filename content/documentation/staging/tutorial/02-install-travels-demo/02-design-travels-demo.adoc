...
++++
<a class="image-popup-fit-height" href="/images/tutorial/02-02-updated-telemetry.png" title="Updated Telemetry">
    <img src="/images/tutorial/02-02-updated-telemetry.png" style="display:block;margin: 0 auto;" />
</a>
++++
