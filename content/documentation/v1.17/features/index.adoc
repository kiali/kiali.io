...
Check out the link:/documentation/v1.17/runtimes-monitoring/[documentation page, window=_blank] to learn more about it.
++++
...
Check the complete link:/documentation/v1.17/validations/[list of validations] for further information.
...
Check https://github.com/kiali/kiali/blob/v1.12/operator/deploy/kiali/kiali_cr.yaml#L134[Kiali Operator CR, window=_blank] to get more details about how to configure this option.
