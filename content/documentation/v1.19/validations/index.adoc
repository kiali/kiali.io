...
https://github.com/kiali/kiali/blob/v1.18/business/checkers/authorization/service_binding_checker.go[Validator source code, window="_blank"] +
https://istio.io/v1.3/docs/reference/config/authorization/istio.rbac.v1alpha1/#ServiceRoleBinding[Istio documentation, window="_blank"]
...
https://github.com/kiali/kiali/blob/v1.18/business/checkers/authorization/workload_selector_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/blob/v1.20/business/checkers/authorization/no_host_checker.go[Validator source code, window="_blank"] +
https://istio.io/docs/reference/config/security/authorization-policy[AuthorizationPolicy documentation, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.18/business/checkers/destinationrules/multi_match_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.20/business/checkers/destinationrules/no_dest_checker.go[Validator source code, window="_blank"] +
https://istio.io/docs/reference/config/networking/destination-rule/#DestinationRule[Destination rule documentation, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/destinationrules/traffic_policy_checker.go[Validator source code, window="_blank"]
...
==== Resolution
Add a PeerAuthentication within the `istio-system` namespace without specifying targets but setting peers mtls mode to STRICT or PERMISSIVE. The PeerAuthentication should be like link:/files/validation_examples/401-PeerAuth.yaml[this, window="_blank"].
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/destinationrules/meshwide_mtls_checker.go[Validator source code, window="_blank"] +
...
==== See Also
https://github.com/kiali/kiali/blob/v1.19/business/checkers/destinationrules/namespacewide_mtls_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/destinationrules/disabled_namespacewide_mtls_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/destinationrules/disabled_namespacewide_mtls_checker.go[Validator source code, window="_blank"] +
https://istio.io/docs/tasks/security/authentication/authn-policy/#globally-enabling-istio-mutual-tls-in-strict-mode[Globally enabling Istio mutual TLS, window="_blank"]
...
==== Resolution
Add a ServiceMeshPolicy named as default without specifying targets but setting peers mtls mode to STRICT or PERMISSIVE. The ServiceMeshPolicy should be like link:/files/validation_examples/401.yaml[this, window="_blank"].
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/gateways/multi_match_checker.go[Validator source code, window=_blank] +
...
https://github.com/kiali/kiali/blob/v1.19/business/checkers/gateways/selector_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.17/business/checkers/meshpolicies/mesh_mtls_checker.go[Validator source code, window="_blank"] +
https://istio.io/docs/tasks/security/authn-policy/#globally-enabling-istio-mutual-tls-in-strict-mode[Globally enabling Istio mutual TLS, window="_blank"]
...
https://github.com/kiali/kiali/tree/v1.17/business/checkers/policies/namespace_mtls_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/blob/v1.19/business/checkers/services/port_mapping_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/blob/v1.18/business/checkers/authorization/service_checker.go[Validator source code, window="_blank"] +
https://istio.io/v1.3/docs/reference/config/authorization/istio.rbac.v1alpha1/#AccessRule[Istio documentation, window="_blank"]
...
https://github.com/kiali/kiali/tree/v1.18/business/checkers/sidecars/workload_selector_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.18/business/checkers/sidecars/multi_match_checker.go[Validator source code, window="_blank"] +
https://istio.io/docs/reference/config/networking/sidecar/[Sidecar documentation, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/sidecars/egress_listener_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/sidecars/global_checker.go[Validator source code, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/virtual_services/no_host_checker.go[Validator source code, window="_blank"] +
https://istio.io/docs/reference/config/networking/destination-rule/#DestinationRule[Destination rule documentation, window="_blank"] +
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/virtual_services/no_gateway_checker.go[Validator source code, window="_blank"]
...
https://github.com/kiali/kiali/blob/v1.19/business/checkers/virtual_services/no_host_checker.go[Validator source code, window="_blank"]
...
https://github.com/kiali/kiali/blob/v1.19/business/checkers/virtual_services/route_checker.go[Validator source code, window="_blank"]
...
https://istio.io/docs/ops/best-practices/traffic-management/#split-virtual-services[Istio documentation: Split large virtual services and destination rules into multiple resources, window="_blank"]
https://github.com/kiali/kiali/blob/v1.19/business/checkers/virtual_services/single_host_checker.go[Validator source code, window="_blank"]
...
https://github.com/kiali/kiali/tree/v1.19/business/checkers/virtual_services/subset_presence_checker.go[Validator source code, window="_blank"]
