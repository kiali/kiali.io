...
icon:lightbulb[size=1x]{nbsp} This page is intended for users installing Kiali for the first time. These instructions are not recommended to install Kiali in production environments. In the case of custom installations, visit the link:{{< ref "/documentation/v1.33/installation-guide" >}}[installation guide].
...
Kiali will be able to access all existing and future namespaces. See link:{{< ref "/documentation/v1.33/installation-guide#_namespace_management" >}}[Namespace Management] for more information if you want to change that behavior.
...
Find more detailed information on installing Kiali see the link:{{< ref "/documentation/v1.33/installation-guide" >}}[installation guide].
