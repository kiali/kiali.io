...
icon:info[size=2x] {nbsp}{nbsp}{nbsp}{nbsp}In order to have the best experience with Kiali you will need to update to use a link:../installation-guide/#_browser_version_requirements[supported browser].
