...
=== KIA1001 - DestinationWeight on route doesn't have a valid service (host not found)
...
=== KIA1002 - VirtualService is pointing to a non-existent gateway
...
=== KIA1003 - VirtualService doesn't define any route protocol
...
=== KIA1004 - The weight is assumed to be 100 because there is only one route destination
...
=== KIA1005 - This subset is already referenced in another route destination
...
=== KIA1006 - More than one Virtual Service for same host
