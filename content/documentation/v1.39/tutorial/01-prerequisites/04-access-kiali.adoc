...
++++
<a class="image-popup-fit-height" href="/images/tutorial/01-04-access-kiali-v1.29.0.png" title="Verify Kiali Access">
    <img src="/images/tutorial/01-04-access-kiali-v1.29.0.png" style="display:block;margin: 0 auto;" />
</a>
++++
