...
https://github.com/kiali/kiali/tree/v1.12/business/checkers/virtualservices/no_host_checker.go[Validator source code, window="_blank"] +
https://istio.io/v1.0/docs/reference/config/istio.networking.v1alpha3/#DestinationRule[Destination rule documentation, window="_blank"]
...
https://github.com/kiali/kiali/tree/v1.12/business/checkers/virtualservices/no_gateway_checker.go[Validator source code, window="_blank"]
...
https://github.com/kiali/kiali/tree/v1.12/business/checkers/virtualservices/subset_presence_checker.go[source code, window="_blank"]
...
https://github.com/kiali/kiali/blob/v1.12/business/checkers/virtualservices/no_host_checker.go[Validator source code, window="_blank"]
...
https://github.com/kiali/kiali/blob/v1.12/business/checkers/virtualservices/single_host_checker.go[Validator source code, window="_blank"]
