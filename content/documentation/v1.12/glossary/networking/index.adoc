...
For more information see the <<Destination Rule>> definition in the link:https://istio.io/v1.0/docs/reference/config/istio.networking.v1alpha3/#DestinationRule[Istio Destination Rule Documentation].
...
For more information see the <<Gateway>> definition in the link:https://istio.io/v1.0/docs/reference/config/istio.networking.v1alpha3/#Gateway[Istio Gateway Documentation].
...
For more information see the <<Port>> definition in link:https://istio.io/v1.0/docs/reference/config/istio.networking.v1alpha3/#Port[Istio Port Documentation].
...
For more information see the <<Subset>> definition in the link:https://istio.io/v1.0/docs/reference/config/istio.networking.v1alpha3/#Subset[Istio Subset Documentation].
