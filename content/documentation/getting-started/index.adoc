...
If the packaged version of Kiali is sufficient then choose the options to install Kiali and then continue to link:#_open_the_ui[Open the UI].  If you prefer to install the latest Kiali then do not choose the options to install Kiali, or delete it as necessary, and continue with the steps below.
