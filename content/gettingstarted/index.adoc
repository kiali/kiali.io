...
Then install Kiali. Note that this assumes you are installing v0.9.0 - set your VERSION_LABEL to the appropriate version you want to install. This also assumes Istio is installed in the `istio-system` namespace.
...
To deploy Kiali to your Istio-enabled Kubernetes cluster you can run the following commands. Note that this assumes you are installing v0.9.0 - set your VERSION_LABEL to the appropriate version you want to install. This also assumes Istio is installed in the `istio-system` namespace.
